...
export function SessionError({ kind }: SessionErrorProps) {
  ...
  return (
    <main className="mx-auto flex min-h-dvh w-full max-w-md items-center bg-white px-5 py-12 sm:px-6">
      <section className="w-full text-center" aria-labelledby="session-error-title">
        <p className="mb-3 text-sm font-medium text-slate-500">AI Photobooth</p>
        <h1 id="session-error-title" className="text-2xl font-semibold tracking-tight text-slate-950">
          {content.title}
        </h1>
